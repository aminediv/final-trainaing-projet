  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative bg-gradient-to-r from-green-500/20 via-emerald-500/20 to-green-500/20 border-b border-white/10 p-6 text-center">
          <motion.button 
            onClick={onClose}
          ...
          <motion.div
            ...
            className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-green-400 to-emerald-500 flex items-center justify-center shadow-lg shadow-green-500/40"
          >
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
        ...
        >
          ...
          <p className="text-[10px] text-white/40 uppercase tracking-wider mt-3">Confirmation Code</p>
          <p className="text-lg font-bold text-white font-mono tracking-wider">{confirmationNumber}</p>
        </motion.div>
        ...
        >
          <h3 className="font-bold text-white text-lg">{movieTitle}</h3>
          ...
          <div className="flex items-center gap-1.5 text-sm text-white/70 bg-white/5 rounded-lg p-2.5">
          ...
          <div className="flex justify-between items-center pt-2 border-t border-white/10">
            ...
            <span className="text-xl font-bold text-green-400">{grandTotal} MAD</span>
          </div>
        </motion.div>
